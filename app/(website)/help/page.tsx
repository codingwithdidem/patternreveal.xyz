    ...
    questions: [
      {
        ...
        answer:
          "The free plan includes: 5 daily reflections, Basic pattern analysis, Email support, Mobile app access",
      },
      {
        question: "How do I upgrade to Pro?",
        answer:
          "You can upgrade anytime from your account settings. Pro includes unlimited reflections, advanced AI insights, relationship health tracking, priority support, custom insights, and data export features.",
      },
      {
