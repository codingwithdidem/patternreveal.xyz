    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p className="mb-6">
            Welcome to PatternReveal. These Terms and Conditions ("Terms")
            govern your use of our relationship reflection and pattern analysis
            platform ("Service") operated by PatternReveal ("us," "we," or
            "our").
          </p>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell className="px-6 py-4">
                  PatternReveal website and application operated by
                  PatternReveal for relationship reflection and pattern
                  analysis.
                </TableCell>
              </TableRow>
              <TableRow>
              ...
              <TableRow>
                ...
                <TableCell className="px-6 py-4">
                  Automated analysis of user content using artificial
                  intelligence to generate insights and patterns.
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
          ...
          <p className="mb-6">
            By creating an account, accessing our platform, or using our
          ...
          <p className="mb-6">
            ...
            considered a breach of our fair use policies. As such, we reserve
            the right to suspend or terminate your access to the Services if we
          ...
          <p className="mb-6">
            ...
            harmful patterns, is permitted and may be essential for your
            personal growth and safety. However, using the platform to justify
            or perpetuate harmful behaviors toward others is prohibited.
          </p>
          <p className="mb-6">
            Furthermore, while you can use our free plan for personal purposes,
            excessive usage that impacts service performance for other users is
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              During the term of this Agreement, you grant PatternReveal the
              right to access, collect, use, process, store, disclose,
              sublicense, and transmit your data solely for the purposes of
              operating, providing, maintaining, and improving PatternReveal and
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              Our platform, software, and algorithms are protected by
          ...
          <p className="mb-4">
            ...
            usage patterns, and other statistical data from users of the
            Services ("Usage Data"). All Usage Data is aggregated and anonymized
            so that it cannot be used to identify you, your customers, or any
            specific individual. Usage Data is not considered your data or
            personal data, cannot be re-identified, and will be deemed
            PatternReveal's data. All Usage Data is anonymized and
            de-identified.
          </p>
          <p className="mb-6">
            Any data that cannot be associated with you or your customers may
            also be used by PatternReveal for support and service improvements.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              You should consult qualified professionals for serious
              relationship or mental health concerns
            </li>
            <li>
              We are not liable for decisions made based on our AI analysis
            </li>
            <li>
              AI analysis is designed to help identify patterns, including
              potentially harmful ones, to support your personal growth and
              safety
            </li>
            <li>
          ...
          <p className="mb-6">
            ...
            OR OTHERWISE – FOR ANY: (i) CONSEQUENTIAL, INCIDENTAL, INDIRECT,
            EXEMPLARY, SPECIAL, AGGRAVATED, OR PUNITIVE DAMAGES; (ii) INCREASED
            COSTS, DIMINUTION IN VALUE, OR LOSS OF BUSINESS, PRODUCTION,
            REVENUES, OR PROFITS; (iii) LOSS OF GOODWILL OR REPUTATION; (iv)
            USE, INABILITY TO USE, LOSS, INTERRUPTION, DELAY, OR RECOVERY OF ANY
            DATA, OR ANY BREACH OF DATA OR SYSTEM SECURITY; OR (v) COST OF
            REPLACEMENT GOODS OR SERVICES – IN EACH CASE REGARDLESS OF WHETHER
            THE PARTY WAS ADVISED OF THE POSSIBILITY OF SUCH LOSSES OR DAMAGES
            OR WHETHER SUCH LOSSES OR DAMAGES WERE OTHERWISE FORESEEABLE.
          </p>

          <p className="mb-6">
            IN NO EVENT WILL EITHER PARTY'S AGGREGATE LIABILITY ARISING OUT OF
            OR RELATED TO THIS AGREEMENT, UNDER ANY LEGAL OR EQUITABLE THEORY,
            EXCEED THE TOTAL SUBSCRIPTION FEES PAID BY CLIENT TO PATTERNREVEAL
            UNDER THIS AGREEMENT FOR THE SIX (6) MONTH PERIOD PRECEDING THE
          ...
          <p className="mb-4">
            ...
            Agreement that is designated as proprietary or confidential by the
            disclosing party, or should reasonably be understood to be
            proprietary or confidential given its nature and the circumstances
            of disclosure.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              protect the other party's Confidential Information with at least
            ...
            <li>
              ...
              third party except to its employees, contractors, or professional
              advisors who have a legitimate need to know the information and
          ...
          <p className="mb-6">
            ...
            act or omission of the receiving party; is rightfully received from
            a third party without restriction on disclosure; is independently
          ...
          <p className="mb-6">
            ...
            required by law, regulation, or court order, provided that it (where
            legally permissible) gives prompt written notice to the disclosing
            party to allow the disclosing party to seek a protective order or
            other remedy. Upon termination of this Agreement, each party will,
            at the disclosing party's request, return or destroy all
            Confidential Information in its possession, subject to any retention
          ...
          <p className="mb-6">
            ...
            attorneys' fees) arising from your use of the Service, violation of
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              if required by a governmental or regulatory authority or as a
          ...
          <p className="mb-4">
            ...
            only through final and binding arbitration, except as set forth
            below. The American Arbitration Association (AAA) will administer
            the arbitration under its Commercial Arbitration Rules. The
          ...
          <p className="mb-4">
            ...
            non-breaching party may bring a lawsuit in the federal or state
            courts of San Francisco County, California solely for injunctive
            relief to stop the breach without first engaging in the informal
            dispute notice process described above. The state or federal courts
            sitting in San Francisco County, California shall have exclusive
            jurisdiction and venue over any dispute arising out of your use of
            the PatternReveal Services, subject to the mandatory arbitration
            provisions herein, and you hereby consent to the jurisdiction of
            those courts.
          </p>
          ...
          <p className="mb-4">
            ...
            decision to opt-out to: legal@patternreveal.xyz with the subject
            line "ARBITRATION OPT-OUT". The notice must be sent within thirty
            (30) days of the date that you first accept these Terms, otherwise
            you shall be bound to arbitrate any disputes in accordance with
            these Terms. If you opt-out of these arbitration provisions,
            PatternReveal also will not be bound by them.
          </p>
          ...
          <p className="mb-6">
            Other than when it comes to Client's payment responsibilities,
            neither of us will be held responsible if we can't meet our
            obligations under this Agreement because of something beyond our
            control, including fires, power outages, extreme weather, labour
            disputes or government interventions (a "Force Majeure Event") as
            long as the party unable to fulfill its obligations notifies the
            other party promptly and gets back on track as soon as possible. If
            a Force Majeure Event causes a delay that lasts for 90 days without
            a solution, either of us may terminate the Agreement without any
            penalties.
          </p>
          ...
          <div className="bg-muted p-6 rounded-lg mt-8">
            ...
            <p className="mb-2">
              If you are experiencing a mental health emergency or are in
              danger, please contact emergency services immediately:
            </p>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              PatternReveal is not a substitute for professional help. If you
              are experiencing abuse or are in danger, please seek immediate
