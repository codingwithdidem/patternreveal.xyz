      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p className="mb-6">
            ...
            information when you use our relationship reflection and pattern
            analysis platform.
          </p>
          ...
          <Table className="mb-6">
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className="px-6 py-4">
                  A natural or legal person who determines the purposes for
                  which and the manner in which any personal data are processed.
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              <strong>Analytics Cookies:</strong> Used by PostHog and Tinybird
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              <strong>Google:</strong> Authentication services (when using
              Google sign-in)
            </li>
          </ul>
          ...
          <p className="mb-4">
            If you're located in the European Union (EU) or European Economic
            Area (EEA), you are entitled to specific rights under the{" "}
            <a
          ...
          <p className="mb-4">
            We respect your right to control your personal data. If you'd like
            to access, update, restrict, or delete the information we hold about
            you, just email us at info@patternreveal.xyz. Under GDPR, you may
            have the right to:
          </p>
          <ul className="list-disc pl-6 mb-6">
            <li>
          ...
          <p className="mb-6">
            ...
            for any purpose. You are the only owner of your Personal Data and
          ...
          <p className="mb-6">
            ...
            our Service ("Subprocessors"), provide Service on our behalf,
